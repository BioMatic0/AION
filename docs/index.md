...
- [Source code](https://github.com/BioMatic0/AION)
...
- Next.js web app
- NestJS API
- shared packages for governance, prompts, AI core and UI
- Windows packaging
...
The source repository includes CI and test configuration. Public releases are
